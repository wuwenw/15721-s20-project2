 ...
 public:
  ...
  class TreeNode : public BaseOp {
   public:
    ...
    void UnlockQueue(std::queue<common::SpinLatch *> *path_queue) {
  ...
  void UnlockQueue(std::vector<TreeNodeUnion *> path_queue, bool is_read) {
